...
// Purpose: Returns the height of the tree plus one.
// Returns: height of the tree plus one.
// NOTE: returns '0' for an empty tree. 
...
// Purpose: Prints the Tree in Post-Order    
